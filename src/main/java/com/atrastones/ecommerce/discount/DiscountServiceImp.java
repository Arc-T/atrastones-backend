...
import com.atrastones.ecommerce.discount.common.*;
import com.atrastones.ecommerce.product.ProductPriceDTO;
import com.atrastones.ecommerce.product.common.ProductDTO;
import com.atrastones.infrastructure.error.BusinessRuleException;
import com.atrastones.infrastructure.error.InvalidRequestException;
import com.atrastones.infrastructure.error.ResourceNotFoundException;
...
public class DiscountServiceImp implements DiscountService {
    ...
    public DiscountDTO get(Long id) {
        return discountRepository.get(id).map(DiscountDTO::toDTO)
                .orElseThrow(() -> new ResourceNotFoundException("discount.not.found"));
    }

    @Override
    public Page<DiscountDTO> getAll(Pageable pageable, DiscountSearchDTO search) {
        return discountRepository.getAll(pageable, search).map(DiscountDTO::toDTO);
    }
