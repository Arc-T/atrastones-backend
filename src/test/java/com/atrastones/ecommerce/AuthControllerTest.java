...
class AuthControllerTest extends BaseControllerTest {
    ...
    void attemptLogin_ok() throws Exception {
        LoginDTO validCredentials = new LoginDTO("361629708", "1234321");
    ...
    void attemptLogin_forbidden(Language language) throws Exception {
        LoginDTO invalidCredentials = new LoginDTO("00000000000", "88888888888");
    ...
    void attemptLogin_badRequest(Language language) throws Exception {
        LoginDTO invalidCredentials = new LoginDTO(null, null);
