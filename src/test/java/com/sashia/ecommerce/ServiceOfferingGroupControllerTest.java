...
class ServiceOfferingGroupControllerTest extends BaseControllerTest {
    ...
    class GetAllServiceOfferingGroups {
    ...
    class GetServiceOfferingGroupById {
    ...
    class CreateServiceOfferingGroup {
    ...
    class UpdateServiceOfferingGroup {
    ...
    class DeleteServiceOfferingGroup {
